...
export function some_edits ( str: string ) {
    ...
    str = str.replace( / صلى‌الله‌عليه‌وآله‌وسلم مْ/g, " صلى‌الله‌عليه‌وآله‌وسلم " );
    str = str.replace( /صلى‌الله‌عليه‌وآله‌وسلم أَجْمَعِينَ/g, " صلى‌الله‌عليه‌وآله‌وسلم " );
    str = str.replace( /صلى‌الله‌عليه‌وآله‌وسلم مْ أَجْمَعِينَ/g, " صلى‌الله‌عليه‌وآله‌وسلم " );
    ...
    str = str.replace( /صَلَّى اللَّهُ عَلَيْهِمْ/g, " عليهم‌السلام " );
    str = str.replace( /صَلَوَاتُ اللَّهِ عَلَيْهِمْ/g, " عليهم‌السلام " );
    str = str.replace( /عليهم‌السلام أَجْمَعِينَ/g, " عليهم‌السلام " );
