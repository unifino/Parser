...
function test () {
    ...
    // console.log( db_misc.findIndex( x => x.a === t1 ) );
    // console.log( db_misc.findIndex( x => x.a === t2 ) );
    // 24003
    // 13662
    // console.log( db_misc.findIndex( x => x.i === 24003 ) );
    // console.log( db_misc.findIndex( x => x.i === 13662 ) );
    34571
    33526
    console.log( db_misc[ 33526 ].inFaParts.length - db_misc[ 34571 ].inFaParts.length );
...
function init () {
    ...
    // examine_X_by_A( 34571, 33526, db_misc )
