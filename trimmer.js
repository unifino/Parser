...
for ( let x of kafi ) {
    ...
    x.a = x.a.replace( /<span class=libFootnoteAlaem>عليهم‌السلام<\/span>/g, " عليهم‌السلام " );
    ...
    x.a = x.a.replace( /<span class=libFootnoteAlaem>صلى‌الله‌عليه‌وآله<\/span>/g, " صلى‌الله‌عليه‌وآله‌وسلم " );
    x.a = x.a.replace( /<span class=libAlaem>عليه‌السلام<\/span>/g, " عليه‌السلام " );
    ...
    x.a = x.a.replace( /<span class=libFootnoteAlaem>عليهما‌السلام<\/span>/g, " عليهما‌السلام " );
    x.a = x.a.replace( /<span class=libAlaem>صلى‌الله‌عليه‌وآله\(<\/span>/g, " صلى‌الله‌عليه‌وآله‌وسلم " );
    x.a = x.a.replace( /<span class=libAlaem>صلى‌الله‌عليه‌وآله‌<\/span>/g, " صلى‌الله‌عليه‌وآله‌وسلم " );
    x.a = x.a.replace( /<span class=libAlaem>صلى‌الله‌عليه‌وآله‌وسلم<\/span>/g, " صلى‌الله‌عليه‌وآله‌وسلم " );
    x.a = x.a.replace( /<span class=libFootnoteAlaem>صلى‌الله‌عليه‌وآله‌وسلم<\/span>/g, " صلى‌الله‌عليه‌وآله‌وسلم " );
    x.a = x.a.replace( /<span class=libAlaem>عليها‌السلام\(<\/span>/g, " عليها‌السلام " );
    ...
    x.a = x.a.replace( /<span class=libFootnoteAlaem>عليه‌السلام<\/span>/g, " عليه‌السلام " );
    x.a = x.a.replace( /<span class=libAlaem>رحمه‌الله<\/span>/g, " رحمه‌الله " );
    x.a = x.a.replace( /<span class=libNormal>.<\/span>/g, " . " );
    x.a = x.a.replace( /<span class=libFootnoteAlaem>.<\/span>/g, " . " );
    ...
    // .. Caution
    x.a = x.a.replace( /<span class=libAlaem>عليه‌السلام\(<\/span>/g, " عليه‌السلام " );
    // x.a = x.a.replace( /<span class=libNormal>/g, " " );
    // x.a = x.a.replace( /<span class=libFootnoteAie>/g, " " );
    // x.a = x.a.replace( /<span class=libAie>/g, " " );
    // x.a = x.a.replace( /<\/span>/g, " " );
    x.a = x.a.replace( / +/g, " " );
    x.a = x.a.trim();

    // let count1 = ( x.a.match( /«/g ) || [] ).length;
    // let count2 = ( x.a.match( /»/g ) || [] ).length;
    // if ( x.a.replace( /»(.*?)/, "" ) ) test += x.a + "\n";
    // if ( count1 != 1 || count2 != 1 ) console.log( count1 , count2  );
    // console.log( x.a.indexOf( "«" ) );
    // console.log( x.a.indexOf( "»" ) - x.a.indexOf( "«" ) );
