...
function a_0_9 ( db: TS.db ) {
    ...
    for( let p of db ) {
        ...
        // .. module S - H - S - A
        // ! join: 443,465,466,927,1679,2173,2929,2973,3654,4177,4208,4298,
        ...
        // ! 8188,8450,8503,8682,8880,8991,9024,9048,9264,مَا يَقْرَبُ مِنْهُ
        // ! 9314,9359,9391,9698,الْحَدِيثَ
        ...
        // ! 21669,21752,21822,22048,22402,22813,22815,22825,23109
    ...
    //         14269,14277,14281,14285,14303,15587,19355,19940,327,
    //     ];
    ...
    let cdnBox = [
        [1148,2],[1622,2],[3154,3],[3837,3],[4294,3],[4799,2],[5046,2],
        [5924,3],[7125,3],[7820,2],[7878,2],[8713,2],[11143,2],[11611,2],
        [13245,2],[13429,2],[13658,2],[13933,3],[14038,2],[15459,2],
        [15944,2],[16209,3],[19159,2],[19799,2],[20676,2],[20693,2],
        [21304,2],[21337,2],[21388,2],[21799,3]
    ]

    return db.filter( x => typeof x.a === "undefined" );
